...
const Page = () => {
  ...
  let findProduct:Data | undefined = data.find(shoe => shoe.id === Number(searchParams.name))
 ...
 useEffect(()=>{
  ...
  <div className='flex space-x-4 mx-auto max-w-4xl flex-col mb-12'>
   ...
   <div className='bg-white flex items-center w-4/4 p-16 rounded-xl'>
       <Image src={`${findProduct?.img}`} width={550} height={550} alt={`image ${findProduct?.title}`} className='mx-auto w-auto h-auto items-center justify-center'
      priority />
     </div>
    <div >
    ...
    <Link href='/'>
      ...
      <p className='mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla molestiae temporibus aut perspiciatis cupiditate dolorem sit expedita quisquam. Nihil, 
